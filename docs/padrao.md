...
A ideia desse arquivo é ser uma base padronizada para a criação de novos artefatos documentados de projeto.

## Estrutura Base

Para qualquer artefato a ser desenvolvido, um exemplo que pode ser seguido é:
...
A ata de reuniões feita pelo grupo deve seguir o seguinte template:
```markdown
...
| Versão | Data       | Descrição                                      | Autor               | Revisor               |
|--------|------------|------------------------------------------------|---------------------|-----------------------|
| 1.0    | 06/06/2026 | Primeira versão do artefato de padronização de documentação | [Gabriel Freitas Balbino](https://github.com/gabrielfreitass1) | [Gabriel Freitas Balbino](https://github.com/gabrielfreitass1) |
